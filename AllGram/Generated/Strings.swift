...
internal enum L10n {
    ...
    enum Tabs {
        static let home = L10n.tr("Localizable", "tabs.home")
        static let chats = L10n.tr("Localizable", "tabs.chats")
        static let clubs = L10n.tr("Localizable", "tabs.clubs")
        static let more = L10n.tr("Localizable", "tabs.more")
    }
    
    enum LanguageSettings {
        static let title = L10n.tr("Localizable", "language-settings.title")
        static let current = L10n.tr("Localizable", "language-settings.current")
        static let otherAvailable = L10n.tr("Localizable", "language-settings.other-available")
    }
}
...
//      let format = LocalisationManager.shared.appBundle.localizedString(forKey: key, value: nil, table: table)
