...
//import UIKit
//
//// From https://stackoverflow.com/a/46234519/10353982
//// TODO: Don't forget to update when new devices come out
...
//
//extension Model {
//    /// Returns `true` only for iPhones with square screens
//    var isSquareScreenPhone: Bool {
//        switch self {
//        case .iPhone4, .iPhone4S, .iPhone5, .iPhone5S, .iPhone5C, .iPhone6, .iPhone6Plus, .iPhone6S, .iPhone6SPlus, .iPhoneSE, .iPhone7, .iPhone7Plus, .iPhone8, .iPhone8Plus, .iPhoneSE2: return true
//        default: return false
//        }
//    }
//    /// Returns `true` only for iPhones with rounded screens
//    var isRoundedScreenPhone: Bool {
//        switch self {
//        case .iPhoneX, .iPhoneXS, .iPhoneXSMax, .iPhoneXR, .iPhone11, .iPhone11Pro, .iPhone11ProMax, .iPhone12Mini, .iPhone12, .iPhone12Pro, .iPhone12ProMax, .iPhone13Mini, .iPhone13, .iPhone13Pro, .iPhone13ProMax: return true
//        default: return false
//        }
//    }
//}
