...
struct NewCreatePostView: View {
    ...
    init(feedVM: NewClubFeedViewModel) {
        self.feedVM = feedVM
...
extension NewCreatePostView: Equatable {
    static func == (lhs: NewCreatePostView, rhs: NewCreatePostView) -> Bool {
        lhs.feedVM.clubRoomId == rhs.feedVM.clubRoomId && lhs.inputHandler == rhs.inputHandler
    }
}
